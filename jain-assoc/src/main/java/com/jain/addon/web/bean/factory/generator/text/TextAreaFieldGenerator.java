...
/**
 * <code>TextAreaFieldGenerator<code>
 * @author Lokesh Jain
 * @since Nov 16, 2012
 * @version 1.0.3
 */
@SuppressWarnings("serial")
public class TextAreaFieldGenerator extends AbstractFieldGenerator {

	public TextAreaFieldGenerator(Locale locale, I18NProvider provider) {
